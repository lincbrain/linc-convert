...
class TestMosaicInfo:
    ...
    def test_stitch_circular_mean(self):
        ...
        tile1 = TileInfo(
            x=0, y=0,
            image=da.full((10, 10), chunks=(5, 5), dtype=np.float32, fill_value=0.0)  # 0 degrees
        )
        tile2 = TileInfo(
            x=5, y=5,
            image=da.full((10, 10), chunks=(5, 5), dtype=np.float32, fill_value=180.0)  # 180 degrees
        )
        ...
        # In the overlap region, circular mean of 0° and 180° should be around 90° or 270°
