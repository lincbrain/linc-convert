...
def test_transfer():
    ...
    subprocess.Popen(f"linc-convert lsm transfer --input-dir '{input_dir}' --dandiset-url 'https://lincbrain.org/dandiset/000051' --dandi-instance 'linc' --subject 'test1' --output-dir '.' --max-size-gb 0.02 --no-upload", env=os.environ.copy(), shell=True, check=True)
