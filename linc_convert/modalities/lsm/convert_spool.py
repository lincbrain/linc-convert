"""Convert spool .dat file sets or ome.zarr files generated by the LSM pipeline into a consolidated Zarr."""
...
def convert_spool_zarr(
    ...
    *,
    ...
    """
    Convert a collection of spool files or ome_zarr files generated by the LSM pipeline into a large Zarr.
